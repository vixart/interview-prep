// Табличный тест бизнес-логики с заглушкой MathSolverStub:
// внешний сервис не нужен, проверяется только логика Processor.
package solver
...
// заглушка: заранее заданные ответы на заранее известные входы
