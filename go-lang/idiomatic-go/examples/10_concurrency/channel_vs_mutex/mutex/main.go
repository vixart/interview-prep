// Та же задача через shared memory: общая map + RWMutex.
// Короче и быстрее, чем вариант с каналом, но кто и когда трогает данные,
// видно только по расстановке Lock/RLock — за этим нужно следить руками.
package main
