// Общее состояние БЕЗ мьютекса: map живет внутри одной горутины-владельца,
// а другие горутины присылают ей в канал функции-команды. Гонки невозможны
// by design, потому что доступ к данным есть только у одной горутины.
// Сравни с соседним примером mutex — та же задача через shared memory.
package main
