// Свой тип ошибки, который умеет оборачивать: поле Err + метод Unwrap() error.
// Только после этого errors.Is/errors.As смогут пройти сквозь него по цепочке.
package main
...
func (se StatusErr) Unwrap() error {
	// без этого метода errors.Is/As не пройдут сквозь наш тип
	return se.Err
}
