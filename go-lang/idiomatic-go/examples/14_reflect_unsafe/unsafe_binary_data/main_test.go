// Бенчмарк: разбор бинарных данных через unsafe.Pointer против encoding/binary.
// Тесты проверяют, что оба способа дают одинаковую структуру.
package main
...
func BenchmarkDataFromBytesUnsafe(b *testing.B) {
	// unsafe против encoding/binary — сравни ns/op в выводе
	for i := 0; i < b.N; i++ {
